    ...
    $.when(
        ...
        function(firstResponse, secondResponse) {
            ...
            if (errorResponse.status === 404) {
                ...
                let restTime = new Date(errorResponse.getResponseHeader('X-RateLimit-Reset')*1000);
                $('#gh-user-data').html(`<h4>Too many requests, please wait until ${restTime.toLocaleTimeString()}</h4>`)
            } else {
